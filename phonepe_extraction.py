...
path1 = "/Users/rajesh/pulse/data/aggregated/transaction/country/india/state/"
...
path2 = "/Users/rajesh/pulse/data/aggregated/user/country/india/state/"
...
path3 = "/Users/rajesh/pulse/data/map/transaction/hover/country/india/state/"
...
path4 = "/Users/rajesh/pulse/data/map/user/hover/country/india/state/"
...
path5 = "/Users/rajesh/pulse/data/top/transaction/country/india/state/"
...
path6 = "/Users/rajesh/pulse/data/top/user/country/india/state/"
...
db=psycopg2.connect(host='localhost', user='postgres', password="Rajesh@123", port=5432, database="PHONEPE_PULSE")
cursor=db.cursor()
...
for i,row in df_map_trans.iterrows():
    RAJ = "INSERT INTO map_trans VALUES (%s,%s,%s,%s,%s,%s)"
    cursor.execute(RAJ, tuple(row))
    db.commit()
...
for i,row in df_map_user.iterrows():
    RAJ = "INSERT INTO map_user VALUES (%s,%s,%s,%s,%s,%s)"
    cursor.execute(RAJ, tuple(row))
    db.commit()
...
for i,row in df_top_trans.iterrows():
    RAJ = "INSERT INTO top_trans VALUES (%s,%s,%s,%s,%s,%s)"
    cursor.execute(RAJ, tuple(row))
    db.commit()
...
for i,row in df_top_user.iterrows():
    RAJ = "INSERT INTO top_user VALUES (%s,%s,%s,%s,%s)"
    cursor.execute(RAJ, tuple(row))
    db.commit()
