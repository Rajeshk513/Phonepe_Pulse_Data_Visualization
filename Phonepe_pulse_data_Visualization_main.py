...
db = psycopg2.connect(host='localhost', user='postgres', password='Rajesh@123',database='PHONEPE_PULSE')

cursor = db.cursor()

icon = Image.open("/Users/rajesh/Downloads/phonepe.png")
st.set_page_config(page_title= "Phonepe Pulse Data Visualization | By RAJESH",
                   page_icon= icon,
                   layout= "wide",
                   initial_sidebar_state= "expanded",
                   menu_items={'About': """# This dashboard app is created by *RAJESH K*!"""})
...
# MENU 1 - HOME
if selected == "Home":
    st.image("/Users/rajesh/Downloads/1111.png",width=300)
    st.markdown("# :rainbow[Data Visualization and Exploration]")
    st.markdown("## :rainbow[A User-Friendly Tool Using Streamlit and Plotly]")
    col1, col2 = st.columns([3, 2], gap="medium")
    with col1:
        st.write(" ")
        st.write(" ")
        st.markdown("### :rainbow[Domain :] Fintech")
        st.markdown(
            "### :rainbow[Technologies used :] Github Cloning, Python, Pandas, MySQL, mysql-connector-python, Streamlit, and Plotly.")
        st.markdown(
    ...
    with col2:
        video_file = open('/Users/rajesh/Downloads/AA.mp4', 'rb')
        video_bytes = video_file.read()

        st.video(video_bytes)

        st.link_button(":rainbow[DOWNLOADAPP]", "https://www.phonepe.com/app-download/")
...
if selected == "Explore Data":
    ...
    if Type == "Transactions":
        ...
        with col1:
            ...
            df2 = pd.read_csv('/Users/rajesh/CSVDATA/state.csv')
            df1.State = df2
...
if selected == "About":
    ...
    with col1:
        ...
        st.write("https://github.com/Rajeshk513/Phonepe_Pulse_Data_Visualization")
        st.write("**:rainbow[Image and content source]** ⬇️")
        st.write(
    ...
    with col2:
        ...
        st.write(" ")
        st.write(" ")
        st.image("/Users/rajesh/Downloads/phonepe_pulse.jpeg")